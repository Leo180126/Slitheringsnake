      ...
      textures_(textures)
{
    ...
    Segment* bufferSegm = new Segment(
        { tileEdgeLength_ * headX, tileEdgeLength_ * headY },
        tileEdgeLength_,
        Segment::Type::Head,
        Direction::Right);
    ...
    field_->setSnakeBlockAt(headX, headY);

    // Body segment
    bufferSegm = new Segment(
        { tileEdgeLength_ * bodyX, tileEdgeLength_ * bodyY },
        tileEdgeLength_,
        Segment::Type::Body,
        Direction::Right);
    ...
    segmentList_.push_back(bufferSegm);
    field_->setSnakeBlockAt(bodyX, bodyY);

    // Tail segment
    bufferSegm = new Segment(
        { tileEdgeLength_ * tailX, tileEdgeLength_ * tailY },
        tileEdgeLength_,
        Segment::Type::Tail,
        Direction::Right);
    ...
    segmentList_.push_back(bufferSegm);
    field_->setSnakeBlockAt(tailX, tailY);
}
